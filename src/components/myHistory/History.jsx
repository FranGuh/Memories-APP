...
import portada from '../../assets/carlaHistoria.png'; // .png en minúsculas
import literatureImg from "../../assets/literatureKarla.png";
import '../myHistory/History.css';
import title from '../../assets/miHistoriaTitulo.png'; // .png en minúsculas
const History = () => {
  return (
